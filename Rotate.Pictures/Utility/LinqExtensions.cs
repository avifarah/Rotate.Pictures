...
{
	/// <summary>
	/// Allows Linq methods Except, Intersect and Union spcifiy a comparer method externally and optionally provide HashCode externally.
	/// </summary>
	public static class LinqExtensions
	{
		...
		public static IEnumerable<T> Intersect<T>(this IEnumerable<T> a, IEnumerable<T> b, Func<T, T, bool> cmpr, Func<T, int> hashCode = null) => a.Intersect(b, new LinqComparer<T>(cmpr, hashCode));
